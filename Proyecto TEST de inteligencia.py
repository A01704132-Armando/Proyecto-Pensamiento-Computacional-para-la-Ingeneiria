...
### Aqui agregue el uso de matrices para calcular el modulo del vector resultante de una suma de vectores 
...
#Inicio del programa
#Ya termine de implementar contadores y el programa ya esta completo
...
print()
print()
###Cambie este problema anterior por un probelma de vectores para usar las matrices
...
if cont_mate!=cont_español:
    if cont_mate<cont_español:
        print ("Dados los resultados de tu examen", nombre, "es notable que tu inteligencia en español es superior a tu inteligencia en matemáticas")
    else:
        print ("Dados los resultados de tu examen", nombre, "es notable que tu inteligencia en matemáticas es superior a tu inteligencia en español")
else:
    print ("Dados los resultados de tu examen", nombre, "podemos afirmar que dominas tanto las matemáticas como el español por igual")